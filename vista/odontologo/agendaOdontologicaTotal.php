        ...
        if ($result->num_rows > 0) {
            ...
            while ($fila = $result->fetch_object()) {
                echo "<tr>
                        ...
                        <td>
                            <button class='btn editar-btn' onclick='editarCita({$fila->ID_CITA})'>Asitio</button>
                            <button class='btn eliminar-btn' onclick='confirmarEliminar({$fila->ID_CITA})'>No Asistio</button>
                        </td>
                    </tr>";
            }
